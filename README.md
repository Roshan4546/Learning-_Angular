...
Angular CLI (Command Line Interface) is a tool that helps developers create, test and deploy Angular applications

Command that helps you to develop Angular Application.

* to create a component in root app
